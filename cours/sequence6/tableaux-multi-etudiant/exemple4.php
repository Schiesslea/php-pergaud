...
// Chaque élément représente une personne avec son numéro, son nom, son prénom et son âge
...
echo "-------------------------------------" . PHP_EOL;
foreach ($personnes as $cle => $personne) {
    foreach ($personne as $cle2 => $valeur) {
        echo "personnes[$cle][$cle2] = $valeur" .PHP_EOL;
    }
    echo PHP_EOL;
}
